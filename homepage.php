    ...
    <body>
        ...
        <div class="section">
            <div class="content">
                ...
                <div class="buttons">
                    <a href="tutorial.php" class="getStarted">Get Started</a>
                    <a href="learnMore.php" class="learnMore">Learn More</a> <!--Need to make another reference website soon -->
                </div>
            </div>
        </div>
